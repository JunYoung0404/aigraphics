...
class App{
    ...
    _setupModel(){
        ...
        async function loadFont(that) {
            ...
            const geometry = new TextGeometry("JUNYOUNG", {
                font : font, 
                size : 5, 
                height : 1.5, 
                curveSegments : 4, 
            ...
            const fillMaterial = new THREE.MeshPhongMaterial({color : 0xfff550}); 
            const cube = new THREE.Mesh(geometry, fillMaterial); 
    
            const lineMaterial = new THREE.LineBasicMaterial({color : 0xffff}); 
